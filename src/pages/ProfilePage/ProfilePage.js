...
import { Box, Grid, Stack, Typography,Button , TextField, Dialog, DialogActions, DialogContent, DialogTitle} from '@mui/material';
...
console.log (formData)
  ...
  JuUniVerseAxios.put("/sys-user/profile-picture",{photoAsBase64:formData?.profilePic,fileExtension:formData?.profilePicEx
  }).then(res=>{
  ...
  JuUniVerseAxios.put("/sys-user/cover-picture",{photoAsBase64:formData?.coverPic,fileExtension:formData?.coverPicEx
  }).then(res=>{
  ...
  JuUniVerseAxios.put("/sys-user/bio",{bio:formData.bio
  }).then(res=>{
    setRefershPage(refershPage+1)
